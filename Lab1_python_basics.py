...
# Лаба 2
# Задание 1:
# 1.1 создайте список, заполненный случайными числами
list = []
minElValue = 10;    
maxElValue = 99;
minSize = 20;
maxSize = 30;
k = 0;
while(k < randint(minSize, maxSize)):
    list.append(randint(minElValue, maxElValue))
    k = k + 1

# 1.2 создайте цикл, который проходит все элементы списка 
# и суммирует только четные значения
summ = 0
for el in list:
    if (el % 2 == 0):
        summ = summ + el;

# 1.3 выведите полученную сумму на экран в консоли
print('Сумма четных чисел в списке: ', summ)
